...
const ReactionTab: React.FC<IReactionTabProps> = ({
  ...
  return (
    <TouchableOpacity
      onPress={onPress}
      className={`px-4 py-2 flex-row items-center gap-2 border-b-2 ${
...
export const ReactionsModal: React.FC<IReactionsModalProps> = ({
  ...
  return (
    <Portal>
      ...
      >
        <Dialog.Title className="text-xl dark:text-darkTextColor text-ligtTextColor">
          Reactions
        </Dialog.Title>
